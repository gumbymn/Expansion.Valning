 ...
 *
*/
#include "$CurrentDir:\\mpmissions\\Expansion.Valning\\expansion\\ExpansionObjectSpawnTools.c"
#include "$CurrentDir:\\mpmissions\\Expansion.Valning\\expansion\\missions\\MissionConstructor.c"
...
void main()
{
	...
	// Enable custom loot
	GetCEApi().ExportProxyData( "7500 0 7500", 35000 );  //Center of map, radius of how far to go out and find buildings.
